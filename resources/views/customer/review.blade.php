            ...
            <form action="#" method="POST" class="space-y-4">
                ...
                <div>
                    <select name="category" class="w-full text-xs px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 focus:outline-none focus:border-[#dfc365] transition-colors appearance-none cursor-pointer" required>
                        ...
                        <option value="po">🔒 Weekend Pre-Order</option>
                        <option value="custom">👑 Special Custom Order</option>
                    </select>
                </div>
                ...
                <div class="flex flex-col items-center justify-center gap-1 mt-2">
                    ...
                    <div class="flex items-center gap-1 cursor-pointer" id="star-rating-container">
                        ...
                        <button type="button" class="star-btn text-[#dfc365] text-2xl focus:outline-none transition-transform hover:scale-110" data-value="4">★</button>
                        <button type="button" class="star-btn text-[#dfc365] text-2xl focus:outline-none transition-transform hover:scale-110" data-value="5">★</button>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        stars.forEach(star => {
            star.addEventListener('click', function() {
                ...
                // Warnai ulang bintang
                stars.forEach(s => {
                    if (s.getAttribute('data-value') <= value) {
                        s.classList.remove('text-slate-200');
                        s.classList.add('text-[#dfc365]');
                    } else {
                        s.classList.remove('text-[#dfc365]');
