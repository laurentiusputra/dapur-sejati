...
@section('content')
<div class="min-h-screen bg-[#f4ebd0] flex items-center justify-center pt-[140px] pb-20 px-4">
    <div class="bg-white rounded-[32px] p-8 sm:p-10 shadow-2xl w-full max-w-md transform transition-all duration-300">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-700 font-bold text-lg mt-1">Welcome Back</p>
        </div>

        <!-- Alert Error jika Login Gagal -->
        @if($errors->any())
            <div class="mb-4 bg-red-50 border border-red-200 text-red-600 text-xs font-semibold p-3 rounded-xl">
                {{ $errors->first() }}
            </div>
        @endif
        ...
        <form action="{{ url('/login') }}" method="POST" class="space-y-5">
            ...
            <div>
                <label for="email" class="block text-[10px] font-black uppercase tracking-wider text-slate-400 mb-2">Email Address</label>
                <div class="relative">
            ...
            <div>
                <label for="password" class="block text-[10px] font-black uppercase tracking-wider text-slate-400 mb-2">Password</label>
                <div class="relative">
            ...
            <button type="submit" class="w-full bg-[#4a2c11] hover:bg-[#36200c] text-white font-bold py-3.5 rounded-xl text-sm transition-colors shadow-md tracking-wide mt-2">
                Sign In
            </button>
        </form>
        ...
        <div class="relative flex items-center justify-center my-6">
            ...
            <span class="absolute bg-white px-3 text-[9px] font-black uppercase tracking-widest text-slate-400">Or Continue With</span>
        </div>
        ...
        <p class="text-center text-xs text-slate-500 mt-8 font-medium">
            Don't have an account? <a href="{{ url('/register') }}" class="text-[#ca7d5c] hover:underline font-bold">Sign Up</a>
        </p>
